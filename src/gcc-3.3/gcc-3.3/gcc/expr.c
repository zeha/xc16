     ...
     enum expand_modifier modifier;
{
  ...
  switch (code)
	...
	/* Possibly avoid switching back and forth here.  */
        /* push and pop temp slots, just in case the value of the expr is not    
           used ... any preserved temp slots in the inlined version can be freed 
           once inlined function has finished */
        push_temp_slots();
