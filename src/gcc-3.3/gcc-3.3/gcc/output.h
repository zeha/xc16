...
/* get a tree describing the constant string */
extern tree constant_string(rtx x);
...
extern SECTION_FLAGS_INT get_named_section_flags PARAMS ((const char *));
extern bool set_named_section_flags	PARAMS ((const char *, 
						 SECTION_FLAGS_INT ));
extern void named_section_flags		PARAMS ((const char *, 
						 SECTION_FLAGS_INT));
