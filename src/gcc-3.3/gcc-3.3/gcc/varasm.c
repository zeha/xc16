  ...
  if (desc == 0)
    {
	 ...
	 future calls to this function to find.  */
      ...
      /* we don't want to call add this to the hash table 
        ...
        we don't need desc, but I don't want to re-write the rest of the
        function - whats a few bytes wasted amongs the rest of the dross? */
      if (pic30_pushed_constant_section() == 0)
#endif
	  ...
	  if (defstr)
	    {
	      struct deferred_string *p = *defstr;
              ...
              pic30_cache_conversion_state(x, p->exp);
