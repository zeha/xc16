...
struct tree_common GTY(())
{
  ...
  unsigned int target_qualifiers;
...
#define TYPE_TARGET_QUALIFIER(NODE) \
    (TYPE_CHECK (NODE)->common.target_qualifiers)
...
#define TYPE_QUAL_TARGET_SHIFT 3
...
#define TYPE_QUALS(NODE)					\
  ((TYPE_READONLY (NODE) * TYPE_QUAL_CONST)			\
   ...
   | (TYPE_TARGET_QUALIFIER(NODE) << TYPE_QUAL_TARGET_SHIFT))
